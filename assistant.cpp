...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER SHREY|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER SHREY";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="password")
        {
            ...
            do{
                ...
                {
                    cout<<"I'm a personal assistant created by Master Shrey !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="open Microsoft Word")
                {
                    ...
                    //string phrase = "opening Microsoft Word";git 
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                ...
                else if(command=="open book")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","C:\\Users\\patil\\Documents\\12 Rules to Learn to Code EBook.pdf",NULL, NULL, SW_NORMAL);
                }
                ...
                {
                    cout<<"Good Bye Master Shrey, see you soon!"<<endl;
                    string phrase = "Good Bye Master Shrey, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
